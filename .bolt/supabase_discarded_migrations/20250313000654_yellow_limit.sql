/*
  # Get Filtered Requests Function v2

  1. New Function
    - get_filtered_requests: Returns filtered time and planner requests
...
BEGIN
  ...
  WHERE (p_company_id IS NULL OR ep.company_id = p_company_id)
    ...
    AND (p_delegation IS NULL OR ep.delegation = p_delegation)
