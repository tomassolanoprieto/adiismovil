/*
  # Fix filtered requests function for supervisors

  1. Changes
    - Update function signature to match supervisor needs
    - Add proper parameter handling for work centers array
    - Ensure proper type handling for all columns
    - Add proper filtering by work centers
...
BEGIN
  ...
  WHERE 
    (p_work_center IS NULL OR ep.work_centers && p_work_center)
