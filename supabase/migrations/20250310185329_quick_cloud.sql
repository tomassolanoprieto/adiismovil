/*
  # Fix supervisor center requests function

  1. Changes
    - Create function to get filtered requests for supervisors
    - Add proper filtering by work center and date range
    - Handle both time and planner requests
    - Return unified request format
...
-- Create new function with proper parameters and logic
